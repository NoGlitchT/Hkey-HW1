...
public class LaundryService extends HotelService{
    private static String serviceDescription = "This service washes sheets and clothing.";
    private static BigDecimal baseCost = BigDecimal.valueOf(15.0);

    public LaundryService(LocalDate start, LocalDate end) {
        super(start, end);
